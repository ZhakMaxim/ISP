...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 396792887304345122, ; hash 0x581b107592d5622, from name: ISP_253504_Zhak.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 11
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2475895480426108633, ; hash 0x225c25d253cb16d9, from name: aot-ISP_253504_Zhak
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 60
	...
	%struct.DSOCacheEntry {
		i64 5506050415225776183, ; hash 0x4c696bae2aeca837, from name: aot-ISP_253504_Zhak.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 133
	...
	%struct.DSOCacheEntry {
		i64 12022284651377319809, ; hash 0xa6d7bc3191f9df81, from name: libaot-ISP_253504_Zhak.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 306
	...
	%struct.DSOCacheEntry {
		i64 14784062723597908577, ; hash 0xcd2b8ab7c125ba61, from name: ISP_253504_Zhak
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 386
	...
	%struct.DSOCacheEntry {
		i64 16468639149792441328, ; hash 0xe48c5c0d597833f0, from name: libaot-ISP_253504_Zhak
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ISP_253504_Zhak.dll.so
		ptr null; void* handle (0x0)
	}, ; 428
...
@.env.3 = private unnamed_addr constant [37 x i8] c"36bdc418-d279-4f26-9285-0459257082f0\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.isp_253504_zhak\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [30 x i8] c"libaot-ISP_253504_Zhak.dll.so\00", align 16
